// This file contains model code to integrate igv.js into the genome browser, specifically to support loading
// local files and sensitive URLs.  In this model the browser page is simulated with a static HTML page and
...
// remains open while the browser page is in use, providing a cache of sorts for the local file blobs.  On
...
(function () {
    ...
    async function createIGVBrowser(config) {
        ...
        // as if the user had dragged a track image => ucsc track image drag + update of positionDisplay
